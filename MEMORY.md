# BigCommerce Hub Driver Memory
## Scope
- Package role: Normalization (Drivers)
- Purpose: This package operates within the Normalization (Drivers) layer of the APIs Hub SaaS hierarchy, providing data normalization for the BigCommerce ecosystem.
...
## Current notes
- Driver layer should normalize BigCommerce data for orchestration.